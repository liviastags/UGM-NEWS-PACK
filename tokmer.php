...
<head>
    ...
    <title>Persebaran Toko Merah Perlengkapan Mahasiswa</title>
...
<body>
    ...
    this._div.innerHTML = '<h2>PERSEBARAN TOKO MERAH</h2>'
    };
    title.addTo(map);
...
var baseMaps = {
    ...
    onAdd: function(map) {
    var img = L.DomUtil.create('img');
    img.src = 'assets/img/legend/tokmer1.jpg';
